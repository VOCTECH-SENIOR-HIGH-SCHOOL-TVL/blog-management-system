            ...
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="bordered col-md-5" style="padding: 40px">
                        ...
                        <div class="row mt-4">
                            <div class="col-sm-12">
                                <form class="form-group" method="POST" action="<?php echo e(route('post.store')); ?>" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\wamp64\www\blog-management-system-2\resources\views/pages/create_blog.blade.php ENDPATH**/ ?>