    ...
    <div class="container my-5">
      <div class="profile-card2">
        ...
        <div class="profile-body2">
          <img src="<?php echo e($user->picture); ?>" alt="User  Picture" class="profile-picture2">
...
<?php echo $__env->make('pages.profile_page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\blog-management-system-2\resources\views/dashboard/users/users_card.blade.php ENDPATH**/ ?>